...
class Features(tf.keras.layers.Layer):
    def __init__(self):
        ...
        self.reshape = layers.Reshape((2, 2, 2048))
...
checkpoint_path = "/work/jprieto/data/remote/EGower/jprieto/train/stack_training_resnet_conf_10122021_weights/stack_training_resnet_conf_21122021"
