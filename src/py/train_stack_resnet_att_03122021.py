...
checkpoint_path = "/work/jprieto/data/remote/EGower/jprieto/train/stack_training_resnet_conf_03122021"
...
model_patches = tf.keras.models.load_model("/work/jprieto/data/remote/EGower/jprieto/train/patch_training_resnet_03122021")
...
model.fit(dataset, validation_data=dataset_validation, workers=4, epochs=200, callbacks=[model_early_stopping_callback, model_checkpoint_callback])
