...
model_path = "/work/jprieto/data/remote/EGower/jprieto/train/patch_training_resnet_att_13112021"
...
# print(predictions)
with open(os.path.join(output_dir, 'patch_training_resnet_att_13112021_timedistributed.pickle'), 'wb') as f:
