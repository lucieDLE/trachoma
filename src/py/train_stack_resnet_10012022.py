...
class Features(tf.keras.layers.Layer):
    def __init__(self):
        ...
        self.conv0 = layers.Conv2D(1024, (2, 2), strides=(2, 2))
        self.conv1 = layers.Conv2D(512, (2, 2), strides=(2, 2))
...
checkpoint_path = "/work/jprieto/data/remote/EGower/jprieto/train/stack_training_resnet_att_10012022_weights/stack_training_resnet_att_10012022"
...
with strategy.scope():
    ...
    model_patches.load_weights("/work/jprieto/data/remote/EGower/jprieto/train/patch_training_resnet_10012022_weights/patch_training_resnet_10012022")
