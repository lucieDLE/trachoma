...
with open(csv_path_stacks.replace(".csv", "_05052022_prediction.pickle"), 'wb') as f:
...
test_df.to_csv(csv_path_stacks.replace(".csv", "_05052022_prediction.csv"), index=False)
