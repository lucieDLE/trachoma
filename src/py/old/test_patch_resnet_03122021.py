...
checkpoint_path = "/work/jprieto/data/remote/EGower/jprieto/train/patch_training_resnet_03122021_weights"
...
# model = tf.keras.models.load_model(checkpoint_path, custom_objects={'TTModel': TTModel, 'Features': Features})
...
with open(os.path.join(output_dir, 'patch_training_resnet_03122021.pickle'), 'wb') as f:
