...
for fold in range(2, 3):
    ...
    print(bcolors.OKBLUE, "Training fold", fold, bcolors.ENDC)
    ...
    train_df = pd.read_csv("/work/jprieto/data/remote/EGower/hinashah/Analysis_Set_20220326/trachoma_bsl_mtss_besrat_field_patches_train_20220326_trainfold" + str(fold) + "_train.csv")
