...
model_path = "train/train_patch_efficientnet_b4_14032022/model.pt"
...
with open(os.path.join(output_dir, 'trachoma_normals_healthy_sev123_epi_patches_test_14032022.pickle'), 'wb') as f:
    pickle.dump((predictions, features), f)

test_df["pred"] = predictions
test_df.to_csv("/work/jprieto/data/remote/EGower/jprieto/test_output/trachoma_normals_healthy_sev123_epi_patches_test_14032022.csv", index=False)
