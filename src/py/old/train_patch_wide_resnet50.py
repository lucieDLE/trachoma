...
import monai
from monai.data import create_test_image_2d, pad_list_data_collate, decollate_batch
...
class TrainTransforms(nn.Module):
    def __init__(self):
        ...
        self.T = T.Compose([
            T.GaussianBlur((7, 7), sigma=(0.001, 2.0)),
...
def main(rank, world_size):
    ...
    val_loader = DataLoader(val_ds, sampler=val_sampler, batch_size=1, num_workers=8, collate_fn=pad_list_data_collate)
    ...
    early_stop = EarlyStopping(patience=10, verbose=True,
        path='train/train_patch_wide_resnet_15032022/model.pt')
