...
#         self.feat.conv1 = nn.Conv2d(32, 64, (2, 2), stride=2)
#         self.conv0 = nn.Conv2d(3, 32, (2, 2), stride=2)
#         self.conv2 = nn.Conv2d(2048, 256, (2, 2), stride=2)
...
class Features(nn.Module):
    def __init__(self):
        super(Features, self).__init__()
        self.feat = models.efficientnet_b0()
        self.feat.classifier = Identity()
...
class TTNet(nn.Module):
    def __init__(self):
        ...
        self.Attention = SelfAttention(256, 128)
    ...
    def forward(self, x):
        ...
        x_a, w_a, w_s = self.Attention(x, x_pe)
...
def main(rank, world_size):
    ...
    early_stop = EarlyStopping(patience=10, verbose=True,
        path='train/torch_stack_resnet_torch_09032022/model.pt')
