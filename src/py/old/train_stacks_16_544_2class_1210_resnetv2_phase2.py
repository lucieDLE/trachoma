...
class DatasetGenerator:
    def __init__(self, df, unique_class_weights):
        ...
        self.dataset = self.dataset.batch(6)
...
model.load_weights("/work/jprieto/data/remote/EGower/jprieto/train/stack_training_10192021_16_544_2class/cp-0017.ckpt")

checkpoint_path = "/work/jprieto/data/remote/EGower/jprieto/train/stack_training_10192021_16_544_2class_phase2/cp-{epoch:04d}.ckpt"
