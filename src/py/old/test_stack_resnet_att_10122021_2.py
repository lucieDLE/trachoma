...
model_path = "/work/jprieto/data/remote/EGower/jprieto/train/stack_training_resnet_conf_10122021_weights/stack_training_resnet_conf_10122021"
...
with open(os.path.join(output_dir, 'stack_training_resnet_conf_10122021_2.pickle'), 'wb') as f:
