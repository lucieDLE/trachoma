...
dataset = DatasetGenerator(test_df).get()
...
dataset_stacks_predict = model.predict(dataset, workers=8, verbose=True)
output_dir = "/work/jprieto/data/remote/EGower/jprieto/test_output/"

with open(os.path.join(output_dir, 'trachoma_normals_healthy_sev123_05182021_stack_16_544_10082021_test_06012022.pickle'), 'wb') as f:
