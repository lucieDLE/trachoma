...
class DatasetGenerator:
    def __init__(self, df, unique_class_weights):
        ...
        self.dataset = tf.data.Dataset.from_generator(self.generator,
            ...
            output_shapes=((None, 448, 448, 3), [3], [1])
            )
    ...
    def generator(self):
        ...
        for idx, row in self.df.iterrows():
            ...
            if len(img_np.shape) == 3:
                ...
                img_np = img_np[np.random.choice(16, 4, replace=False)]
                low = 0.85
            ...
            img_np = tf.image.random_crop(img_np, size=(4, 448, 448, 3))
...
checkpoint_path = "/work/jprieto/data/remote/EGower/jprieto/train/patch_stack_resnet_att_29112021"
