...
class TTModel(tf.keras.Model):
    def __init__(self, features = None):
        ...
        self.features = Features()
        if(features):
            self.features.mobile = features.mobile
...
checkpoint_path = "/work/jprieto/data/remote/EGower/jprieto/train/stack_training_mobile_att_31122022_weights/stack_training_mobile_att_03012022"
...
with strategy.scope():
    ...
    model.features.mobile.trainable = False
    model.summary()    
