...
checkpoint_path = "/work/jprieto/data/remote/EGower/jprieto/train/patch_training_resnet_31122021_weights/"
...
with open(os.path.join(output_dir, 'patch_training_resnet_31122021.pickle'), 'wb') as f:
