...
class Features(tf.keras.layers.Layer):
    def __init__(self):
        ...
        q0 = tf.expand_dims(self.mobilenet(x[:,0:224,0:224,:]), axis=1)
        q1 = tf.expand_dims(self.mobilenet(x[:,224:,0:224,:]), axis=1)
        q2 = tf.expand_dims(self.mobilenet(x[:,0:224,224:,:]), axis=1)
        q3 = tf.expand_dims(self.mobilenet(x[:,224:,224:,:]), axis=1)
...
class DatasetGenerator:
    ...
    def generator(self):
        ...
        for idx, row in self.df.iterrows():
            ...
            img_np = tf.image.random_crop(img_np, size=(8, 448, 448, 3))
...
df = pd.read_csv("/work/jprieto/data/remote/EGower/jprieto/trachoma_normals_healthy_sev123_05182021_stack_64_544_10082021.csv")
...
checkpoint_path = "/work/jprieto/data/remote/EGower/jprieto/train/stack_training_10082021_64_544_2class/"
