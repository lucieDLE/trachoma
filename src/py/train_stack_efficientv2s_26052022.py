...
checkpoint_path = "/work/jprieto/data/remote/EGower/jprieto/train/train_stack_efficientv2s_26052022/train_stack_efficientv2s_26052022" 

csv_path_stacks_train = "/work/jprieto/data/remote/EGower/hinashah/Analysis_Set_20220422/trachoma_bsl_mtss_besrat_field_train_20220422_stacks_train.csv"

train_df = pd.read_csv(csv_path_stacks_train)
train_df['class'] = (train_df['class'] >= 1).astype(int)
train_df = shuffle(train_df)

csv_path_stacks_valid = "/work/jprieto/data/remote/EGower/hinashah/Analysis_Set_20220422/trachoma_bsl_mtss_besrat_field_train_20220422_stacks_eval.csv"
...
with strategy.scope():
    ...
    model_patches.load_weights("/work/jprieto/data/remote/EGower/jprieto/train/train_patch_efficientv2s_26052022_weights/train_patch_efficientv2s_26052022")
