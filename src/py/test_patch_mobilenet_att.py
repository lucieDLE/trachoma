...
output_dir = "/work/jprieto/data/remote/EGower/test_output/"
model_path = "/work/jprieto/data/remote/EGower/train/patch_training_mlp_11082021"
...
# print(predictions)
with open(os.path.join(output_dir, 'patch_training_mlp_11082021.pickle'), 'wb') as f:
