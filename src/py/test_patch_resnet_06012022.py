...
checkpoint_path = "/work/jprieto/data/remote/EGower/jprieto/train/patch_training_resnet_06012022_weights/patch_training_resnet_06012022"
...
with open(os.path.join(output_dir, 'patch_training_resnet_06012022.pickle'), 'wb') as f:
